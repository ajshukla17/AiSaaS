    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 my-24'>
            <div className='text-center '>
                <h2 className='text-slate-700 text-[42px] font-semibold'>Powerful AI Tolls</h2>
                <p className='text-gray-500 max-w-lg mx-auto'>Everything you need to create, enhace, and optimize your content with cutting-edge AI tenchnology.</p>
            </div>

            <div className='grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-0 px-2 sm:px-20 xl:px-30'>
