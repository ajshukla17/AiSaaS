...
export default function Footer() {
    return (
        <>
            ...
            <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-gray-500 bg-white pt-10 mt-20">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    <div className="sm:col-span-2 lg:col-span-1">
                        <a href="http://localhost:5173/"> 
                            <img  className='h-15' src={assets.logo} alt="" />
                        </a>
                        <p className="text-sm/7 mt-6">FikrFreeAI is your all-in-one AI toolkit to generate articles, craft titles, design images, remove backgrounds or objects, and even review resumes — fast, smart, and effortless.”</p>
                    </div>
                ...
                <p className="py-4 text-center border-t mt-6 border-slate-200">
                    Copyright 2025 © <a href="https://prebuiltui.com">FikrFreeAi</a> All Right Reserved.
                </p>
            </footer>
        </>
    );
