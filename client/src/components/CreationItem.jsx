...
function CreationItem({item}) {
    const [expanded ,setExpented]=useState(false)
    return ( 
        <div onClick={()=> setExpented(!expanded)} className='p-4 max-w-5xl text-sm bg-white border border-gray-200 rounded-lg cursor-pointer'>
