...
function GenrateImages() {
    const imagestyle = [
        'Realistics' ,'Ghibli style' ,'Anime style' ,'Cartoon style' ,'Fantasy style' ,'3D style','Portrait style'
    ]

    const [selectedstyle, setselectedstyle] = useState('Realistics')
    ...
    const onsbmitHandler =async (e) =>{
        ...
        try{
            setloading(true)
            const prompt = `Generate a blog title for the keyboard  ${input} in the category ${selectedstyle}`
    ...
    return (
        ...
        <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-scale-700'>
            ...
            <form onSubmit={onsbmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
                ...
                <p className='mt-6 text-sm font-medium'>Describe about Image</p>
